...
Rails.application.configure do
  ...
  if ENV["ACTIVE_STORAGE_URLS_EXPIRE_IN_MIN"].present?
    ...
    config.active_storage.urls_expire_in = 60.minutes
  end
  ...
  # Permitir hosts locais para evitar bloqueios por HostAuthorization em desenvolvimento.
  # Isso inclui chamadas via localhost, 127.0.0.1 e 0.0.0.0 (Docker/WSL).
